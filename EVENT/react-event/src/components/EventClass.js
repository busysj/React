...
class EventClass extends Component {
  // props 값은 부모컴포넌트에서 받아오는 값이므로 component에서 미리 받아오고 있다
  constructor(props) {
    ...
    // 클래스 안에서 사용하기 위해 this.onClickEvent 이름을 가진 함수 이름 작성
  ...
  render() {
    ...
    return (
      <div>
        ...
        <br />
        <button
          onClick={this.onClickEvent} // this를 통해서 메소드를 들고온다
        >
          message change
        </button>
        <br />
        <button onClick={this.onChangeMessage}>message change</button>
      </div>
    );
  }
}
